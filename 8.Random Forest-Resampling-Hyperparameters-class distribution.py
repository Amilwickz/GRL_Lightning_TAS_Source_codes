...
param_grid = {
    'n_estimators': [50, 100, 200, 300, 500, 1000],   #  'n_estimators': [50, 100, 200, 300, 500, 1000],
...
custom_feature_names = {
    'Aspect': 'Aspect', 'Elevation': 'Elevation', 'Slope': 'Slope', 'fuel load': 'Fuel load', 'Fuel_type':'Fuel_type',
    'FMI': 'FMI', 'SDI': 'SDI', 'RH': 'RH', 'FFDI': 'FFDI', 'solar_rad': 'Solar rad',
    'max_temp': 'Max temp', 'vp_deficit': 'Vapour press',
    'wind_speed': 'Wind speed', 'wind_direction': 'Wind direction', '1': 'Closed Forest', '2': 'Open Forest', '3': 'Treeless','4': 'Other vegetation'
}
...
custom_colors = {
    ...
    'Fuel load': '#59a89c','Closed Forest': '#59a89c', 'Open Forest': '#59a89c','Treeless': '#59a89c','Other vegetation': '#59a89c','FMI': '#59a89c',
...
custom_feature_names = {
    'Aspect': 'Aspect', 'Elevation': 'Elevation', 'Slope': 'Slope', 'fuel load': 'Fuel load','1': 'Closed Forest', '2': 'Open Forest', '3': 'Treeless','4': 'Other vegetation',
    'FMI': 'FMI', 'SDI': 'SDI', 'RH': 'RH', 'FFDI': 'FFDI', 'solar_rad': 'Solar rad',
    'max_temp': 'Max temp', 'vp_deficit': 'Vapour press',
...
sns.heatmap(correlation_matrix, annot=True, cmap='coolwarm', fmt='.2f', xticklabels=correlation_columns_custom_names, yticklabels=correlation_columns_custom_names, cbar_kws={'orientation': 'vertical'}, annot_kws={"size": 14})
...
metrics_df.to_csv('8_Random_forest_key_variables_mean_std.txt', sep='\t')
